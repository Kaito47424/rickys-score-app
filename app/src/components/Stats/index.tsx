...
export default function StatsModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      <div className="relative bg-white flex flex-col h-full max-h-screen">
        <div className="bg-blue-700 text-white px-4 py-3 flex items-center gap-3 flex-none">
          <button onClick={onClose} className="text-white text-2xl leading-none">‹</button>
          <h2 className="font-bold text-lg">個人成績</h2>
        </div>
